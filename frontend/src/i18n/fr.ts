...
export const fr: Dictionary = {
  ...
  playground: {
    ...
    labelEmittedHint:
      "Gauche : ce que cherche le modèle. Droite : le label émis (vide = identique).",
    ...
    emptyPipeline:
      "Aucun détecteur. Ajoutez-en un depuis vos détecteurs sauvegardés.",
    exportTitle: "Export",
    exportToml: "TOML",
    exportPython: "Python",
    ...
    detectorsHelp:
      "Détecte les données personnelles (regex, NER classique, GLiNER...).",
    spanResolverHelp:
      "Arbitre les détections qui se chevauchent en spans finaux.",
    entityLinkerHelp:
      "Relie les répétitions d'une même valeur pour un jeton commun.",
    entityResolverHelp:
      "Fusionne les entités liées ; fuzzy gère fautes et casse.",
    ...
    noEnabledDetectors:
      "Activez au moins un détecteur pour tester la pipeline.",
      ...
      },
      {
        ...
        table: {
          headers: [
            ...
            "CLOUD Act / FISA 702",
            "RGPD",
            "Accès technique du fournisseur",
            "Entraînement sur vos données",
          ],
          rows: [
            [
              "Fournisseur US, serveurs US",
              "Oui, directement",
            ...
            [
              "Fournisseur US, serveurs UE",
              "Oui (cf. Microsoft Irlande)",
              "S'applique, mais préempté",
              "Oui",
              "Exclu par défaut sur les offres entreprise",
            ],
            [
              "Fournisseur UE",
              "Non (sauf filiale sous contrôle US)",
              "S'applique pleinement",
              "Oui",
              "Exclu par défaut sur les offres payantes",
            ],
            [
              "Modèle local (auto-hébergé)",
              "Non",
              "Vous en êtes responsable",
              "Non : vous êtes le fournisseur",
              "Non : vous le contrôlez",
            ],
          ],
        },
        subsections: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Transferts UE vers US",
              "Déjà affaiblies par Schrems II",
            ],
            [
              "Accord international",
              "Privacy Shield, DPF",
              "Le premier invalidé, le second contesté",
            ],
            [
              "Réglementation régionale",
              "RGPD",
              "Lente à produire des sanctions effectivement appliquées aux LLM",
            ],
            [
