...
const STRINGS = {
  en: {
    ...
    "meca.2": "Substitute",
    "meca.3": "Restore",
    "meca.1.note": "Eight families ship. Keep the one you trust; Presidio plugs in through an extra.",
  ...
  fr: {
    ...
    "meca.2": "Substituer",
    "meca.3": "Rendre",
    "meca.1.note": "Huit familles livrées. Gardez celle en qui vous avez confiance ; Presidio se branche par une option.",
